...
function Naildelights() {
    ...
    const images = [
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product1_2000x.jpg?v=1600241497",
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product2_3d667db8-b812-4415-bd96-a27cfc02ebb4_2000x.jpg?v=1600246623",
    ...
    const nails = [
        ...
        },
        {
            ...
            price: "22,444.12",
            oldprice: "34,662.74",
            image: "https://nellie-theme.myshopify.com/cdn/shop/files/Product4_7f5e0f05-b45d-478c-9478-633bd9151956.jpg?v=1632138633",
            hoverImage: "https://nellie-theme.myshopify.com/cdn/shop/products/Product2_3d667db8-b812-4415-bd96-a27cfc02ebb4_2000x.jpg?v=1600246623",
        },
        {
            id: "dime",
            name: "Dime",
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">All </a> /  <a href="#"> Nail delights</a></h1>
            </div>
