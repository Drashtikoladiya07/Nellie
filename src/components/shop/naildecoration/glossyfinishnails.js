...
function Glossyfinishnails() {
    ...
    const images = [
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product7_1c80f5a4-a4b4-4589-94c0-c99cf62bb969_1080x.jpg?v=1600247209",
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product8_2000x.jpg?v=1600246855",
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product9_1080x.jpg?v=1600247209",
    ];
    const nails = [
        {
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">All </a> /  <a href="#"> Glossy Finish Nails</a></h1>
            </div>
...
export default Glossyfinishnails;
