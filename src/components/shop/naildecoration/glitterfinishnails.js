...
function Glitterfinishnails() {
    ...
    const images = [
        ...
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product6_2000x.jpg?v=1600246855",
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">All </a> /  <a href="#"> Glitter Finish Nails</a></h1>
            </div>
            <div className="max-w-7xl mx-auto pt-20 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col gap-6 py-20">
                    <div>
                        <h1 className="text-3xl font-semibold font-serif">Glitter Finish Nails</h1>
                        <p className="text-gray-500 pt-4">Marques tempus turpis at metus scelerisque placerat nulla deumantos solicitud felis. Pellentesque diam dolor, elementum etos lobortis des mollis ut risus. Sedcus faucibus an sullamcorper mattis drostique des commodo pharetras loremos.Donec pretium egestas sapien et mollis. Lorem ipsum dolor sit amet Sonsectetur adip...</p>
                    </div>
...
export default Glitterfinishnails;
