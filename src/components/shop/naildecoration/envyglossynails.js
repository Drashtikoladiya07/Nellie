...
function Envyglossynails() {
    ...
    const nails = [
        ...
        },
        {
            ...
            price: "21,577.55",
            oldprice: "34,662.74",
            image: "https://nellie-theme.myshopify.com/cdn/shop/products/Product7_066ec19e-31fc-44a0-9591-0d5200de6023_600x.jpg?v=1600247670",
            hoverImage: "https://nellie-theme.myshopify.com/cdn/shop/products/Product9_6a4f5ef7-7c67-4d4e-bf88-37fc5aba3e81_600x.jpg?v=1600247669",
        },
        {
            id: "allureglossynails",
            name: "Allure Glossy Nails",
            about: "Orcus tempus turpls...",
            price: "20,710.99",
            oldprice: "34,662.74",
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">All </a> /  <a href="#"> Envy Glossy Nails</a></h1>
            </div>
...
export default Envyglossynails;
