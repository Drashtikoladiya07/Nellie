...
function Allurenails() {
    const [selectedImage, setSelectedImage] = useState(0);
    const [selectedPattern, setSelectedPattern] = useState("83W56T");
    const [selectedFinish, setSelectedFinish] = useState("Glitter");
    ...
    const images = [
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product9_6a4f5ef7-7c67-4d4e-bf88-37fc5aba3e81_2000x.jpg?v=1600247669",
    ...
    const patterns = ["83W56T", "83W56Z", "83W56Y"];
    const finishes = ["Glitter", "Matte", "Glossy"];
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">All </a> /  <a href="#"> Allure Nails</a></h1>
            </div>
