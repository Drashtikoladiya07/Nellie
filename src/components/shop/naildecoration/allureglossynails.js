...
function Allureglossynails() {
    ...
    const images = [
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product10_2000x.jpg?v=1600247899",
    ...
    const nails = [
        {
            id: "mattefinishnails",
            name: "Matte Finish Nails",
            about: "Gloremu tempus turpls...",
            price: "21,577.55",
            oldprice: "34,662.74",
            image: "https://nellie-theme.myshopify.com/cdn/shop/products/Product6_600x.jpg?v=1600246853",
            hoverImage: "https://nellie-theme.myshopify.com/cdn/shop/products/Product8_600x.jpg?v=1600246855",
        },
        {
            id: "allurenails",
            name: "Allure Nails",
            about: "Perus tempus turpls...",
            price: "20,710.99",
            oldprice: "34,662.74",
            image: "https://nellie-theme.myshopify.com/cdn/shop/products/Product9_6a4f5ef7-7c67-4d4e-bf88-37fc5aba3e81_600x.jpg?v=1600247669",
            hoverImage: "https://nellie-theme.myshopify.com/cdn/shop/products/Product7_066ec19e-31fc-44a0-9591-0d5200de6023_600x.jpg?v=1600247670",
        },
        {
            id: "glossyfinishnails",
            name: "Glossy Finish Nails",
            about: "Tirums tempus turpls...",
            price: "20,710.99",
            oldprice: "34,662.74",
            image: "https://nellie-theme.myshopify.com/cdn/shop/products/Product8_600x.jpg?v=1600246855",
            hoverImage: "https://nellie-theme.myshopify.com/cdn/shop/products/Product6_600x.jpg?v=1600246853",
        },
        {
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">All </a> /  <a href="#"> Allure Glossy Nails</a></h1>
            </div>
            <div className="max-w-7xl mx-auto pt-20 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col gap-6 py-20">
                    <div>
                        <h1 className="text-3xl font-semibold font-serif">Allure Glossy Nails</h1>
                        <p className="text-gray-500 pt-4">Orci tempus turpis at metus scelerisque placerat nulla deumantos solicitud felis. Pellentesque diam dolor, elementum etos lobortis des mollis ut risus. Sedcus faucibus an sullamcorper mattis drostique des commodo pharetras loremos.Donec pretium egestas sapien et mollis. Lorem ipsum dolor sit amet Sonsectetur adipisc...</p>
                    </div>
                    <div className="space-y-3">
                        ...
                        <div>
                            <p className="py-3"><span className="font-medium">Vendor :</span> Nail Delights</p>
...
export default Allureglossynails;
