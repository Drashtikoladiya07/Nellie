...
const catalog = [
    { link: 'naildelights', id: 1, name: 'Nail Delights', price: "66,639.11", oldPrice: "34,662.74", about: 'Rewutm tempus turpis...', img: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product1_600x.jpg?v=1600241497', hoverImg: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product3_f4a0fa87-ab4a-4350-8011-cdf7a18cb5a2_600x.jpg?v=1600246226' },
    { link: 'daintynailbrush', id: 2, name: 'Dainty Nail Brush', price: "33,709.51", oldPrice: "34,662.74", about: 'Eurem tempus turpis...', img: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product14_600x.jpg?v=1600248487', hoverImg: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product14_600x.jpg?v=1600248487' },
    { link: 'aliyanailfile', id: 3, name: 'Aliya Nail File', price: "32,842.94", oldPrice: "34,662.74", about: 'Nam tempus turpis...', img: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product15_600x.jpg?v=1600248596', hoverImg: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product15_600x.jpg?v=1600248596' },
    { link: 'nautical', id: 4, name: 'Nautical', price: "22,444.12", oldPrice: "34,662.74", about: 'Ipsum tempus turpis...', img: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product4_600x.jpg?v=1600241498', hoverImg: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product2_534f80b2-3de0-412f-8098-469b2257a316_600x.jpg?v=1600242077' },
];

function Nailcaretools() {
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">Home </a> /  <a href="#"> Nail Care Tools</a></h1>
            </div>
