...
function Aliyanailfile() {
    ...
    const images = [
        "https://nellie-theme.myshopify.com/cdn/shop/products/Product15_2000x.jpg?v=1600248596",
    ];
    const nails = [
        {
            id: "dime",
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">All </a> /  <a href="#"> Alliya Nail File</a></h1>
            </div>
            <div className="max-w-7xl mx-auto pt-20 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col gap-6 py-20">
                    <div>
                        <h1 className="text-3xl font-semibold font-serif">Alliya Nail File</h1>
                        <p className="text-gray-500 pt-4">Nam tempus turpis at metus scelerisque placerat nulla deumantos solicitud felis. Pellentesque diam dolor, elementum etos lobortis des mollis ut risus. Sedcus faucibus an sullamcorper mattis drostique des commodo pharetras loremos.Donec pretium egestas sapien et mollis. Lorem ipsum dolor sit amet Sonsectetur adipisci...</p>
                    </div>
                    <div className="space-y-3">
                        <p className="text-lg font-medium">Price :{"  "}
                            <span>Rs. 32,842.94</span>
                        ...
                        <div>
                            ...
                            <p className="py-3"><span className="font-medium">Type :</span> Manicur Tool</p>
                            <p className="py-3">
