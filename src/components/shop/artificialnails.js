...
const catalog = [
    { link: 'allurenails', id: 1, name: 'Allure Nails', price: "20,701.52", oldPrice: "34,690.02", about: 'Persus tempus turpis...', img: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product9_600x.jpg?v=1600247209', hoverImg: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product7_1c80f5a4-a4b4-4589-94c0-c99cf62bb969_600x.jpg?v=1600247209' },
    { link: 'glitterfinishnails', id: 2, name: 'Glitter Finish Nails', price: "20,701.52", oldPrice: "34,690.02", about: 'Marques tempus turpis...', img: 'https://nellie-theme.myshopify.com/cdn/shop/collections/Product_8_360x.jpg?v=1600249469', hoverImg: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product6_600x.jpg?v=1600246853' },
    { link: 'glossyfinishnails', id: 3, name: 'Glossy Finish Nails', price: "20,701.52", oldPrice: "34,690.02", about: 'Tirums tempus turpis...', img: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product7_1c80f5a4-a4b4-4589-94c0-c99cf62bb969_600x.jpg?v=1600247209', hoverImg: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product9_600x.jpg?v=1600247209' },
    { link: 'mattefinishnails', id: 4, name: 'Matte Finish Nails', price: "20,701.52", oldPrice: "34,690.02", about: 'Gorumu turpis...', img: 'https://nellie-theme.myshopify.com/cdn/shop/products/Product6_600x.jpg?v=1600246853', hoverImg: 'https://nellie-theme.myshopify.com/cdn/shop/collections/Product_8_360x.jpg?v=1600249469' },
];

function Artificialnails() {
    ...
    return (
        <div>
            <div className="bg-red-50 py-20">
                ...
                <h1 className="text-md tracking-widest text-center py-5"><a href="#">Home </a> /  <a href="#"> Artificial Nails</a></h1>
            </div>
            <div className="flex lg:px-20 py-20">
                ...
                <div className="flex-1 py-6">
                    <div className='w-full border flex'>
                        <img src='https://nellie-theme.myshopify.com/cdn/shop/collections/Product_8_360x.jpg?v=1600249469' className='w-52 h-64' />
                        <h1 className='text-3xl text-center tracking-wider font-serif items-center m-auto'>Artificial Nails</h1>
                    </div>
                    <button
...
export default Artificialnails;